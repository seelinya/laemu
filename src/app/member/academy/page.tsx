...
function SupportWidget() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 bg-accent-gold text-white pl-4 pr-5 py-3.5 shadow-lg hover:bg-accent-gold-hover transition-colors"
    >
      ...
      <MemberTopBar
        ...
        right={
          hasCourseAccess ? (
            ...
            <button
              onClick={openUpgrade}
              className="flex items-center gap-2 bg-accent-gold text-white border border-accent-gold px-4 py-1.5 font-sans font-semibold text-sm hover:bg-accent-gold-hover transition-colors"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" /></svg>
