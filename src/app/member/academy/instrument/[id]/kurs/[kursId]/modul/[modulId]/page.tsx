            ...
            {activeLessonLocked ? (
              <motion.div key={`${activeLessonId}-locked`} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
                <div className="aspect-video bg-dark flex flex-col items-center justify-center text-center px-6 gap-4">
                  ...
                  <Link href="/member/academy" className="bg-accent-gold text-white font-sans text-sm font-semibold px-6 py-3 hover:bg-accent-gold-hover transition-colors">
                    Zur Übersicht →
                  </Link>
                </div>
              </motion.div>
            ...
            <motion.div key={activeLessonId} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }} className="space-y-6">
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                {nextLesson ? (
                  <button
                    onClick={goToNext}
                    className="flex items-center gap-2 font-sans text-sm font-medium bg-dark text-white px-4 py-2.5 hover:bg-accent-gold hover:text-white transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 font-sans text-sm font-medium bg-dark text-white px-5 py-2.5 hover:bg-accent-gold hover:text-white transition-colors"
                  >
            ...
            <section className="border-t border-border pt-8 space-y-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <button
                      ...
                      className="font-sans text-sm bg-dark text-white px-4 py-2 hover:bg-accent-gold hover:text-white transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                    >
                      Kommentar senden
                    </button>
                  </div>
              ...
              <div className="space-y-5">
                {comments.map((comment) => {
                  ...
                  >
                    <Link href={profileHref(comment.isAuthor, comment.handle)} className={`w-9 h-9 ${comment.isTeam ? 'bg-accent-gold text-white' : comment.color + ' text-white'} flex items-center justify-center flex-shrink-0 font-heading font-bold text-xs hover:opacity-80 transition-opacity`}>
                      {comment.initials}
                    </Link>
                          ...
                          {comment.replies.map((r) => {
                            ...
                            return (
                              <div key={r.id} className="flex gap-2.5">
                                <Link href={profileHref(r.name === CURRENT_USER.name, r.handle)} className={`w-7 h-7 ${r.isTeam ? 'bg-accent-gold text-white' : 'bg-dark text-white'} flex items-center justify-center flex-shrink-0 font-heading font-bold text-[10px] hover:opacity-80 transition-opacity`}>{ini}</Link>
                                <div className="flex-1 min-w-0">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              <button
                                ...
                                className="font-sans text-xs bg-dark text-white px-3 py-1.5 hover:bg-accent-gold hover:text-white transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                              >
                                Antwort senden
                              </button>
                              <button
